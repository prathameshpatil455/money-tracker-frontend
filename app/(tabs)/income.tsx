...
const IncomeScreen = () => {
  ...
  const [selectedCategory, setSelectedCategory] = useState(incomeCategoriesWithIcons[0].value);
        ...
        >
          ...
          <View style={styles.recentTransactionsSection}>
            ...
            {incomeTransactions.length > 0 ? (
              ...
              <Text style={styles.noTransactionsText}>No income transactions yet</Text>
            )}
          </View>
        </ScrollView>
